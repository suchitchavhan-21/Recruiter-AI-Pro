...
*   **Gated Entry**: Restricts access automatically to the pre-authorized master administrator email (`sxxxxxxxxxx@gmail.com`) or falls back to secure local passcode credentials.
